...
console.log(biblioteca_juegos_nuevos); // Imprime la nueva longitud del array, que es 5.
...
console.log(biblioteca_juegos); // Imprime el array modificado.
console.log(biblioteca_juegos_eliminados); // Imprime el elemento eliminado, que es el array ['Mario Kart', 'Donkey Kong', 'Kirby'].
